...
Shader "Mtree/SRP/Billboard HDRP"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin][Header(Albedo)]_Color("Color", Color) = (1,1,1,1)
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 VAR_VertexPosition21_g1 = mul( GetObjectToWorldMatrix(), float4( inputMesh.positionOS , 0.0 ) ).xyz;
				...
				transform37_g1.xyz = GetAbsolutePositionWS((transform37_g1).xyz);
				...
				float FUNC_Angle73_g1 = ( VAR_WindStrength43_g1 * ( 1.0 + sin( ( ( ( ( VAR_RandomTime16_g1 * 2.0 ) + FUNC_Turbulence36_g1 ) - ( VAR_VertexPosition21_g1.z / 50.0 ) ) - ( inputMesh.ase_color.r / 20.0 ) ) ) ) * sqrt( inputMesh.ase_color.r ) * 0.2 * VAR_WindPulse274_g1 );
				...
				float3 lerpResult61 = lerp( temp_output_5_0_g1 , inputMesh.positionOS , (float)BillboardWindEnabled);
						...
						)
			{
				...
				surfaceDescription.Albedo = OUT_Albedo45.rgb;
				...
				surfaceDescription.Smoothness = OUT_Smoothness58;
...
/*ASEBEGIN
Version=18800
464;329;1480;753;1490.863;58.39209;1.737518;True;True
...
Node;AmplifyShaderEditor.TexturePropertyNode;2;-1308.361,54.55442;Float;True;Property;_MainTex;Albedo;1;0;Create;False;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;4;-957.0894,434.1565;Half;False;Property;_CutoffHDRP;Cutoff;2;0;Create;False;0;0;0;False;0;False;0.5;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;8;-897.5212,258.5437;Inherit;False;Property;_Color;Color;0;0;Create;True;0;0;0;False;1;Header(Albedo);False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;41;-1227.852,900.655;Inherit;False;Mtree Wind;5;;1;d710ffc7589a70c42a3e6c5220c6279d;7,282,0,280,0,278,0,255,0,269,1,281,0,272,0;0;1;FLOAT3;0
...
Node;AmplifyShaderEditor.IntNode;25;-1289.592,1110.256;Inherit;False;Global;BillboardWindEnabled;BillboardWindEnabled;3;1;[Enum];Create;True;0;2;On;0;Off;1;0;False;0;False;0;1;False;0;1;INT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;54;-1258.275,1712.136;Inherit;False;Property;_Glossiness;Smoothness;4;0;Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;50;890.5921,57.31693;Inherit;False;787.6993;508.11;;5;40;48;44;49;60;Output;0,0,0,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;51;-1297.001,-467.6064;Inherit;False;275;251.3827;;1;6;Variables;1,0,0.7241378,1;0;0
...
WireConnection;87;4;40;0
WireConnection;87;7;60;0
WireConnection;87;9;49;0
WireConnection;87;11;44;0
ASEEND*/
//CHKSM=205B9DC13C12C59D24D9544CE7E1FA5A870E9DFA