...
Shader "Mtree/SRP/Leafs HDRP"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 If252_g525( int m_Switch, float3 m_Leaves, float3 m_Palm, float3 m_Grass, float3 m_None )
			{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				int m_Switch252_g525 = _WindModeLeaves;
				float3 VAR_VertexPosition21_g525 = mul( GetObjectToWorldMatrix(), float4( inputMesh.positionOS , 0.0 ) ).xyz;
				float3 break109_g525 = VAR_VertexPosition21_g525;
				float VAR_WindStrength43_g525 = ( _WindStrength * _GlobalWindInfluence );
				float4 transform37_g525 = mul(GetObjectToWorldMatrix(),float4( 0,0,0,1 ));
				transform37_g525.xyz = GetAbsolutePositionWS((transform37_g525).xyz);
				float2 appendResult38_g525 = (float2(transform37_g525.x , transform37_g525.z));
				float dotResult2_g526 = dot( appendResult38_g525 , float2( 12.9898,78.233 ) );
				float lerpResult8_g526 = lerp( 0.8 , ( ( _RandomWindOffset / 2.0 ) + 0.9 ) , frac( ( sin( dotResult2_g526 ) * 43758.55 ) ));
				float VAR_RandomTime16_g525 = ( ( _TimeParameters.x * 0.05 ) * lerpResult8_g526 );
				float FUNC_Turbulence36_g525 = ( sin( ( ( VAR_RandomTime16_g525 * 40.0 ) - ( VAR_VertexPosition21_g525.z / 15.0 ) ) ) * 0.5 );
				float VAR_WindPulse274_g525 = _WindPulse;
				float FUNC_Angle73_g525 = ( VAR_WindStrength43_g525 * ( 1.0 + sin( ( ( ( ( VAR_RandomTime16_g525 * 2.0 ) + FUNC_Turbulence36_g525 ) - ( VAR_VertexPosition21_g525.z / 50.0 ) ) - ( inputMesh.ase_color.r / 20.0 ) ) ) ) * sqrt( inputMesh.ase_color.r ) * 0.2 * VAR_WindPulse274_g525 );
				float VAR_SinA80_g525 = sin( FUNC_Angle73_g525 );
				float VAR_CosA78_g525 = cos( FUNC_Angle73_g525 );
				float _WindDirection164_g525 = _WindDirection;
				float2 localDirectionalEquation164_g525 = DirectionalEquation( _WindDirection164_g525 );
				float2 break165_g525 = localDirectionalEquation164_g525;
				float VAR_xLerp83_g525 = break165_g525.x;
				float lerpResult118_g525 = lerp( break109_g525.x , ( ( break109_g525.y * VAR_SinA80_g525 ) + ( break109_g525.x * VAR_CosA78_g525 ) ) , VAR_xLerp83_g525);
				float3 break98_g525 = VAR_VertexPosition21_g525;
				float3 break105_g525 = VAR_VertexPosition21_g525;
				float VAR_zLerp95_g525 = break165_g525.y;
				float lerpResult120_g525 = lerp( break105_g525.z , ( ( break105_g525.y * VAR_SinA80_g525 ) + ( break105_g525.z * VAR_CosA78_g525 ) ) , VAR_zLerp95_g525);
				float3 appendResult122_g525 = (float3(lerpResult118_g525 , ( ( break98_g525.y * VAR_CosA78_g525 ) - ( break98_g525.z * VAR_SinA80_g525 ) ) , lerpResult120_g525));
				float3 FUNC_vertexPos123_g525 = appendResult122_g525;
				float3 break236_g525 = FUNC_vertexPos123_g525;
				half FUNC_SinFunction195_g525 = sin( ( ( VAR_RandomTime16_g525 * 200.0 * ( 0.2 + inputMesh.ase_color.g ) ) + ( inputMesh.ase_color.g * 10.0 ) + FUNC_Turbulence36_g525 + ( VAR_VertexPosition21_g525.z / 2.0 ) ) );
				float VAR_GlobalWindTurbulence194_g525 = ( _WindTurbulence * _GlobalTurbulenceInfluence );
				float3 appendResult237_g525 = (float3(break236_g525.x , ( break236_g525.y + ( FUNC_SinFunction195_g525 * inputMesh.ase_color.b * ( FUNC_Angle73_g525 + ( VAR_WindStrength43_g525 / 200.0 ) ) * VAR_GlobalWindTurbulence194_g525 ) ) , break236_g525.z));
				float3 OUT_Leafs_Standalone244_g525 = appendResult237_g525;
				float3 m_Leaves252_g525 = OUT_Leafs_Standalone244_g525;
				float3 ase_worldNormal = TransformObjectToWorldNormal(inputMesh.normalOS);
				float3 normalizedWorldNormal = normalize( ase_worldNormal );
				float3 appendResult234_g525 = (float3(( normalizedWorldNormal.x * inputMesh.ase_color.g ) , ( normalizedWorldNormal.y / inputMesh.ase_color.r ) , ( normalizedWorldNormal.z * inputMesh.ase_color.g )));
				float3 OUT_Palm_Standalone243_g525 = ( ( ( FUNC_SinFunction195_g525 * inputMesh.ase_color.b * ( FUNC_Angle73_g525 + ( VAR_WindStrength43_g525 / 200.0 ) ) * VAR_GlobalWindTurbulence194_g525 ) * appendResult234_g525 ) + FUNC_vertexPos123_g525 );
				float3 m_Palm252_g525 = OUT_Palm_Standalone243_g525;
				float3 break221_g525 = FUNC_vertexPos123_g525;
				float temp_output_202_0_g525 = ( FUNC_SinFunction195_g525 * inputMesh.ase_color.b * ( FUNC_Angle73_g525 + ( VAR_WindStrength43_g525 / 200.0 ) ) );
				float lerpResult203_g525 = lerp( 0.0 , temp_output_202_0_g525 , VAR_xLerp83_g525);
				float lerpResult196_g525 = lerp( 0.0 , temp_output_202_0_g525 , VAR_zLerp95_g525);
				float3 appendResult197_g525 = (float3(( break221_g525.x + lerpResult203_g525 ) , break221_g525.y , ( break221_g525.z + lerpResult196_g525 )));
				float3 OUT_Grass_Standalone245_g525 = appendResult197_g525;
				float3 m_Grass252_g525 = OUT_Grass_Standalone245_g525;
				float3 m_None252_g525 = FUNC_vertexPos123_g525;
				float3 localIf252_g525 = If252_g525( m_Switch252_g525 , m_Leaves252_g525 , m_Palm252_g525 , m_Grass252_g525 , m_None252_g525 );
				float3 OUT_Leafs262_g525 = localIf252_g525;
				float3 temp_output_5_0_g525 = mul( GetWorldToObjectMatrix(), float4( OUT_Leafs262_g525 , 0.0 ) ).xyz;
				float3 OUT_VertexPos261 = temp_output_5_0_g525;
						...
						)
			{
				...
				float4 VAR_Albedo18_g524 = VAR_Albedo101;
				float3 hsvTorgb9_g524 = RGBToHSV( VAR_Albedo18_g524.rgb );
				float3 hsvTorgb13_g524 = HSVToRGB( float3(( ( ( packedInput.ase_color.g - 0.5 ) * _ColorVariation ) + _Hue + hsvTorgb9_g524 ).x,( hsvTorgb9_g524.y * _Saturation ),( hsvTorgb9_g524.z * _Value )) );
				float4 lerpResult19_g524 = lerp( float4( hsvTorgb13_g524 , 0.0 ) , VAR_Albedo18_g524 , (float)_ColorShifting);
				float4 OUT_Albedo254 = lerpResult19_g524;
		...
		Pass
		{
						...
						)
			{
				...
				float OUT_Thickness275 = ( 1.0 - packedInput.ase_texcoord7.zw.x );
...
/*ASEBEGIN
Version=18800
247;508;1480;753;-375.1102;696.421;1;True;True
...
Node;AmplifyShaderEditor.TexturePropertyNode;10;-1819.385,-1751.215;Float;True;Property;_MainTex;Albedo;1;0;Create;False;0;0;0;False;1;;False;None;8981b5bb2b6f2cb46a7660180b7fbbb8;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;30;-1569.232,-1554.536;Half;False;Property;_CutoffHDRP;Cutoff;2;0;Create;False;0;0;0;False;0;False;0.5;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;37;-1789.721,-88.45222;Float;True;Property;_BumpMap;Normal Map;3;0;Create;False;0;0;0;False;1;Header(Normal Texture);False;None;6abcf175224a4044a85c0d091d35f7b7;True;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;26;-1539.303,755.15;Inherit;False;Property;_Glossiness;Smoothness;12;0;Create;False;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;24;-1772.963,1353.167;Half;False;Property;_OcclusionStrength;AO strength;11;0;Create;False;0;0;0;False;1;Header(Other Settings);False;0.6;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;48;-1451.371,133.5333;Half;False;Property;_BumpScale;Normal Strength;4;0;Create;False;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;365;-1785.631,1750.531;Inherit;False;Mtree Wind;14;;525;d710ffc7589a70c42a3e6c5220c6279d;7,282,0,280,0,278,0,255,1,269,1,281,0,272,0;0;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;368;-1421.213,-1144.755;Inherit;False;Mtree Color Shifting;5;;524;4ec4833a692faa04fbef10a6f43e7e28;0;1;15;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.CommentaryNode;265;791.8203,-575.662;Inherit;False;757.7145;754.4375;;9;257;256;9;258;8;355;357;379;396;Output;0,0,0,1;0;0
...
Node;AmplifyShaderEditor.DiffusionProfileNode;379;855.1145,-87.06178;Inherit;False;Property;_DiffusionProfile;Diffusion Profile;13;0;Create;True;0;0;0;False;0;False;bfe65683ace10b94da8b0b1c5c132a8f;0;False;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;51;823.317,-1008.222;Inherit;False;Constant;_MaskClipValue;Mask Clip Value;14;1;[HideInInspector];Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=2DC6561DB79BCC07F4D882513082EB14916739BB